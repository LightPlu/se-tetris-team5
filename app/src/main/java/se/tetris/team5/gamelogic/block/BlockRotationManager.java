...
public class BlockRotationManager {
    ...
    private Block copyBlock(Block original) {
        ...
        if (original instanceof IBlock) copy = new IBlock();
        else if (original instanceof JBlock) copy = new JBlock();
        else if (original instanceof LBlock) copy = new LBlock();
        else if (original instanceof OBlock) copy = new OBlock();
        else if (original instanceof SBlock) copy = new SBlock();
        else if (original instanceof TBlock) copy = new TBlock();
        else if (original instanceof ZBlock) copy = new ZBlock();
