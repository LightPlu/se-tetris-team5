...
public class p2pbattle extends JPanel implements KeyListener {
  ...
  private void showReadyWaiting() {
    ...
    centerPanel.add(Box.createVerticalStrut(20));
    // 채팅 패널 추가
    centerPanel.add(createCenteredComponent(createChatPanel()));
    centerPanel.add(Box.createVerticalGlue());
  ...
  private void initializeGameScreen() {
    ...
    se.tetris.team5.gamelogic.P2PGameEngine opponentEngine = new se.tetris.team5.gamelogic.P2PGameEngine(
      ...
      switch (packet.getType()) {
        ...
        case CHAT_MESSAGE:
          ...
          if (chatMessage != null && !chatMessage.isEmpty()) {
            String sender = isServer ? "클라이언트" : "서버";
  ...
  private void updateOpponentState(GameStatePacket packet) {
    ...
    if (engine instanceof se.tetris.team5.gamelogic.P2PGameEngine) {
      se.tetris.team5.gamelogic.P2PGameEngine p2pEngine = (se.tetris.team5.gamelogic.P2PGameEngine) engine;
  ...
  private void handleGameOver(int winner) {
    ...
    String message = winner == (isServer ? 1 : 2) ? "축하합니다! 승리하셨습니다!\n\n메인 메뉴로 돌아가거나 게임을 종료할 수 있습니다."
        : "아쉽게도 패배하셨습니다...\n\n메인 메뉴로 돌아가거나 게임을 종료할 수 있습니다.";
