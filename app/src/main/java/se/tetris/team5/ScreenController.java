...
public class ScreenController extends JFrame {
  ...
  public void showScreen(String screenName) {
    ...
    // 기존 battleScreen이 살아있으면 리소스 정리 (타이머 등)
    ...
    switch (screenName) {
      ...
      case "score":
        ...
        break;
      case "setting":
        // Clear previous components to avoid visual artifacts (e.g., leftover
        // scoreboard panel)
        textPane.removeAll();
        getContentPane().add(textPane);
  ...
  private void setDefaultIcon() {
    try {
      ...
      // 최후의 수단: 단일 아이콘
      try {
        java.awt.image.BufferedImage fallbackIcon = new java.awt.image.BufferedImage(32, 32,
            java.awt.image.BufferedImage.TYPE_INT_ARGB);
